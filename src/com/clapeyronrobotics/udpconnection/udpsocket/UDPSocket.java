...
public class UDPSocket {
        ...
        listeningThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while(!getLocalSocket().isClosed()) {
                    receiveData = new byte[1024]; //TODO стандартизировать размеры https://ru.wikipedia.org/wiki/UDP (длина датаграммы)
    ...
    public void sendMessage(InetAddress outIP, int outPort, Message message) {
        byte[] sendData;  //TODO стандартизировать размеры https://ru.wikipedia.org/wiki/UDP (длина датаграммы)
